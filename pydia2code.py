...
__author__ = "Timothe Perez"
__license__ = "GPL"
__version__ = "0.1.0"
__maintainer__ = "Timothe Perez"
__email__ = "achille.ash@gmail.com"
__status__ = "Development"


print("=== PyDia2Code C++ Header-only generator ===")
print("Version 0.1.0 | Python 3.4")
...
for namespace in config["namespaces"]:
    try:
        print(namespace + " : Headers for namespace")
